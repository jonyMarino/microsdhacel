...
{
 PWMDTY_ARRAY[salida] = (word)((PWMPER_ARRAY[salida] * (dword)RatioStore[salida] + 5000) / 10000); // Calculate new value of duty 
}
...
{
//  PWMCNT67 = 0;
 /* PWMPRCLK: ??=0,PCKB2=1,PCKB1=0,PCKB0=1,??=0,PCKA2=1,PCKA1=0,PCKA0=1 */
//  PWMPRCLK = 85;                     /* Set prescaler register */ 
//  PWME_PWME7 = 1;
}