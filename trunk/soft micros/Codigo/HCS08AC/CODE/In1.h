...
*/
#define In1_GetVal() ( \
    (bool)((getReg8(PTFD) & 0x01))     /* Return port data */ \
  )
...
*/
#define In1_ClrVal() ( \
    (void)clrReg8Bits(PTFD, 0x01)      /* PTFD0=0x00 */, \
    Shadow_PTF &= ~0x01                /* Set appropriate bit in shadow variable */ \
  )
...
*/
#define In1_SetVal() ( \
    (void)setReg8Bits(PTFD, 0x01)      /* PTFD0=0x01 */, \
    Shadow_PTF |= 0x01                 /* Set appropriate bit in shadow variable */ \
  )
...
*/
#define In1_NegVal() ( \
    (void)invertReg8Bits(PTFD, 0x01)   /* PTFD0=invert */, \
    Shadow_PTF ^= 0x01                 /* Set appropriate bit in shadow variable */ \
  )
...
*/
#define In1_GetDir() ( \
    (bool)((getReg8(PTFDD) & 0x01))    /* Return pin direction, 0==GPI, nonzero==GPO */ \
  )
...
*/
#define In1_SetInput() ( \
    (void)clrReg8Bits(PTFDD, 0x01)     /* PTFDD0=0x00 */ \
  )
