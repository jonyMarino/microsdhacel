...
#define VectorNumber_Vspi2              49
#define VectorNumber_Vtpm3ovf           48
...
#define VectorNumber_Vtpm3ch1           31
#define VectorNumber_Vtpm3ch0           30
#define VectorNumber_Vrti               29
#define VectorNumber_Viic1              28
#define VectorNumber_Vadc1              27
#define VectorNumber_Vkeyboard1         26
#define VectorNumber_Vsci2tx            25
#define VectorNumber_Vsci2rx            24
#define VectorNumber_Vsci2err           23
#define VectorNumber_Vsci1tx            22
#define VectorNumber_Vsci1rx            21
#define VectorNumber_Vsci1err           20
#define VectorNumber_Vspi1              19
#define VectorNumber_Vtpm2ovf           18
#define VectorNumber_Vtpm2ch5           17
#define VectorNumber_Vtpm2ch4           16
#define VectorNumber_Vtpm2ch3           15
#define VectorNumber_Vtpm2ch2           14
...
#define Vspi2                           0x0000FF9C
#define Vtpm3ovf                        0x0000FF9E
...
#define Vtpm3ch1                        0x0000FFC0
#define Vtpm3ch0                        0x0000FFC2
#define Vrti                            0x0000FFC4
#define Viic1                           0x0000FFC6
#define Vadc1                           0x0000FFC8
#define Vkeyboard1                      0x0000FFCA
#define Vsci2tx                         0x0000FFCC
#define Vsci2rx                         0x0000FFCE
#define Vsci2err                        0x0000FFD0
#define Vsci1tx                         0x0000FFD2
#define Vsci1rx                         0x0000FFD4
#define Vsci1err                        0x0000FFD6
#define Vspi1                           0x0000FFD8
#define Vtpm2ovf                        0x0000FFDA
#define Vtpm2ch5                        0x0000FFDC
#define Vtpm2ch4                        0x0000FFDE
#define Vtpm2ch3                        0x0000FFE0
#define Vtpm2ch2                        0x0000FFE2
...
#define ADC1SC1_ADCH0_MASK              0x01
#define ADC1SC1_ADCH1_MASK              0x02
#define ADC1SC1_ADCH2_MASK              0x04
#define ADC1SC1_ADCH3_MASK              0x08
#define ADC1SC1_ADCH4_MASK              0x10
#define ADC1SC1_ADCO_MASK               0x20
#define ADC1SC1_AIEN_MASK               0x40
#define ADC1SC1_COCO_MASK               0x80
#define ADC1SC1_ADCH_MASK               0x1F
#define ADC1SC1_ADCH_BITNUM             0x00
...
#define ADC1SC2_ACFGT_MASK              0x10
#define ADC1SC2_ACFE_MASK               0x20
#define ADC1SC2_ADTRG_MASK              0x40
#define ADC1SC2_ADACT_MASK              0x80
...
typedef union {
  ...
  struct {
    ...
    #define ADC1RH_ADR8_MASK            0x01
    #define ADC1RH_ADR9_MASK            0x02
    #define ADC1RH_ADR_8_MASK           0x03
    #define ADC1RH_ADR_8_BITNUM         0x00
    ...
    #define ADC1RL_ADR0_MASK            0x01
    #define ADC1RL_ADR1_MASK            0x02
    #define ADC1RL_ADR2_MASK            0x04
    #define ADC1RL_ADR3_MASK            0x08
    #define ADC1RL_ADR4_MASK            0x10
    #define ADC1RL_ADR5_MASK            0x20
    #define ADC1RL_ADR6_MASK            0x40
    #define ADC1RL_ADR7_MASK            0x80
...
typedef union {
  ...
  struct {
    ...
    #define ADC1CVH_ADCV8_MASK          0x01
    #define ADC1CVH_ADCV9_MASK          0x02
    #define ADC1CVH_ADCV_8_MASK         0x03
    #define ADC1CVH_ADCV_8_BITNUM       0x00
    ...
    #define ADC1CVL_ADCV0_MASK          0x01
    #define ADC1CVL_ADCV1_MASK          0x02
    #define ADC1CVL_ADCV2_MASK          0x04
    #define ADC1CVL_ADCV3_MASK          0x08
    #define ADC1CVL_ADCV4_MASK          0x10
    #define ADC1CVL_ADCV5_MASK          0x20
    #define ADC1CVL_ADCV6_MASK          0x40
    #define ADC1CVL_ADCV7_MASK          0x80
...
#define ADC1CFG_ADICLK0_MASK            0x01
#define ADC1CFG_ADICLK1_MASK            0x02
#define ADC1CFG_MODE0_MASK              0x04
#define ADC1CFG_MODE1_MASK              0x08
#define ADC1CFG_ADLSMP_MASK             0x10
#define ADC1CFG_ADIV0_MASK              0x20
#define ADC1CFG_ADIV1_MASK              0x40
#define ADC1CFG_ADLPC_MASK              0x80
#define ADC1CFG_ADICLK_MASK             0x03
#define ADC1CFG_ADICLK_BITNUM           0x00
#define ADC1CFG_MODE_MASK               0x0C
#define ADC1CFG_MODE_BITNUM             0x02
#define ADC1CFG_ADIV_MASK               0x60
#define ADC1CFG_ADIV_BITNUM             0x05
...
/*** PTJD - Port J Data Register; 0x0000001A ***/
typedef union {
  byte Byte;
  struct {
...
extern volatile PTJDSTR _PTJD @0x0000001A;
...
/*** PTJDD - Port J Data Direction Register; 0x0000001B ***/
typedef union {
  byte Byte;
  struct {
...
extern volatile PTJDDSTR _PTJDD @0x0000001B;
...
/*** TPM2C2SC - TPM2 Timer Channel 2 Status and Control Register; 0x0000006B ***/
typedef union {
  byte Byte;
  struct {
    byte             :1; 
...
/*** TPM2C2V - TPM2 Timer Channel 2 Value Register; 0x0000006C ***/
typedef union {
  word Word;
   /* Overlapped registers: */
  struct {
    /*** TPM2C2VH - TPM2 Timer Channel 2 Value Register High; 0x0000006C ***/
    union {
      byte Byte;
    } TPM2C2VHSTR;
    ...
    /*** TPM2C2VL - TPM2 Timer Channel 2 Value Register Low; 0x0000006D ***/
    union {
      byte Byte;
    } TPM2C2VLSTR;
...
/*** TPM2C3SC - TPM2 Timer Channel 3 Status and Control Register; 0x0000006E ***/
typedef union {
  byte Byte;
  struct {
    byte             :1; 
...
/*** TPM2C3V - TPM2 Timer Channel 3 Value Register; 0x0000006F ***/
typedef union {
  word Word;
   /* Overlapped registers: */
  struct {
    /*** TPM2C3VH - TPM2 Timer Channel 3 Value Register High; 0x0000006F ***/
    union {
      byte Byte;
    } TPM2C3VHSTR;
    ...
    /*** TPM2C3VL - TPM2 Timer Channel 3 Value Register Low; 0x00000070 ***/
    union {
      byte Byte;
    } TPM2C3VLSTR;
...
/*** TPM2C4SC - TPM2 Timer Channel 4 Status and Control Register; 0x00000071 ***/
typedef union {
  byte Byte;
  struct {
    byte             :1; 
...
/*** TPM2C4V - TPM2 Timer Channel 4 Value Register; 0x00000072 ***/
typedef union {
  word Word;
   /* Overlapped registers: */
  struct {
    /*** TPM2C4VH - TPM2 Timer Channel 4 Value Register High; 0x00000072 ***/
    union {
      byte Byte;
    } TPM2C4VHSTR;
    ...
    /*** TPM2C4VL - TPM2 Timer Channel 4 Value Register Low; 0x00000073 ***/
    union {
      byte Byte;
    } TPM2C4VLSTR;
...
/*** TPM2C5SC - TPM2 Timer Channel 5 Status and Control Register; 0x00000074 ***/
typedef union {
  byte Byte;
  struct {
    byte             :1; 
...
extern volatile TPM2C5SCSTR _TPM2C5SC @0x00000074;
...
#define TPM2C5SC_ELS5A_MASK             0x04
#define TPM2C5SC_ELS5B_MASK             0x08
#define TPM2C5SC_MS5A_MASK              0x10
#define TPM2C5SC_MS5B_MASK              0x20
#define TPM2C5SC_CH5IE_MASK             0x40
#define TPM2C5SC_CH5F_MASK              0x80
#define TPM2C5SC_ELS5x_MASK             0x0C
#define TPM2C5SC_ELS5x_BITNUM           0x02
#define TPM2C5SC_MS5x_MASK              0x30
#define TPM2C5SC_MS5x_BITNUM            0x04


/*** TPM2C5V - TPM2 Timer Channel 5 Value Register; 0x00000075 ***/
typedef union {
  word Word;
   /* Overlapped registers: */
  struct {
    /*** TPM2C5VH - TPM2 Timer Channel 5 Value Register High; 0x00000075 ***/
    union {
      byte Byte;
    } TPM2C5VHSTR;
    ...
    /*** TPM2C5VL - TPM2 Timer Channel 5 Value Register Low; 0x00000076 ***/
    union {
      byte Byte;
    } TPM2C5VLSTR;
...
extern volatile TPM2C5VSTR _TPM2C5V @0x00000075;
...
#define PPAGE_XA14_MASK                 0x01
#define PPAGE_XA15_MASK                 0x02
#define PPAGE_XA16_MASK                 0x04
#define PPAGE_XA_14_MASK                0x07
#define PPAGE_XA_14_BITNUM              0x00
...
#define LAP1_LA8_MASK                   0x01
#define LAP1_LA9_MASK                   0x02
#define LAP1_LA10_MASK                  0x04
#define LAP1_LA11_MASK                  0x08
#define LAP1_LA12_MASK                  0x10
#define LAP1_LA13_MASK                  0x20
#define LAP1_LA14_MASK                  0x40
#define LAP1_LA15_MASK                  0x80
...
#define LAP0_LA0_MASK                   0x01
#define LAP0_LA1_MASK                   0x02
#define LAP0_LA2_MASK                   0x04
#define LAP0_LA3_MASK                   0x08
#define LAP0_LA4_MASK                   0x10
#define LAP0_LA5_MASK                   0x20
#define LAP0_LA6_MASK                   0x40
#define LAP0_LA7_MASK                   0x80
...
#define LWP_D0_MASK                     0x01
#define LWP_D1_MASK                     0x02
#define LWP_D2_MASK                     0x04
#define LWP_D3_MASK                     0x08
#define LWP_D4_MASK                     0x10
#define LWP_D5_MASK                     0x20
#define LWP_D6_MASK                     0x40
#define LWP_D7_MASK                     0x80
...
#define LBP_D0_MASK                     0x01
#define LBP_D1_MASK                     0x02
#define LBP_D2_MASK                     0x04
#define LBP_D3_MASK                     0x08
#define LBP_D4_MASK                     0x10
#define LBP_D5_MASK                     0x20
#define LBP_D6_MASK                     0x40
#define LBP_D7_MASK                     0x80
...
#define LB_D0_MASK                      0x01
#define LB_D1_MASK                      0x02
#define LB_D2_MASK                      0x04
#define LB_D3_MASK                      0x08
#define LB_D4_MASK                      0x10
#define LB_D5_MASK                      0x20
#define LB_D6_MASK                      0x40
#define LB_D7_MASK                      0x80
...
#define LAPAB_D0_MASK                   0x01
#define LAPAB_D1_MASK                   0x02
#define LAPAB_D2_MASK                   0x04
#define LAPAB_D3_MASK                   0x08
#define LAPAB_D4_MASK                   0x10
#define LAPAB_D5_MASK                   0x20
#define LAPAB_D6_MASK                   0x40
#define LAPAB_D7_MASK                   0x80
...
typedef union {
  ...
  struct {
    ...
    #define DBGCCH_Bit8_MASK            0x01
    #define DBGCCH_Bit9_MASK            0x02
    #define DBGCCH_Bit10_MASK           0x04
    #define DBGCCH_Bit11_MASK           0x08
    #define DBGCCH_Bit12_MASK           0x10
    #define DBGCCH_Bit13_MASK           0x20
    #define DBGCCH_Bit14_MASK           0x40
    #define DBGCCH_Bit15_MASK           0x80
    ...
    #define DBGCCL_Bit0_MASK            0x01
    #define DBGCCL_Bit1_MASK            0x02
    #define DBGCCL_Bit2_MASK            0x04
    #define DBGCCL_Bit3_MASK            0x08
    #define DBGCCL_Bit4_MASK            0x10
    #define DBGCCL_Bit5_MASK            0x20
    #define DBGCCL_Bit6_MASK            0x40
    #define DBGCCL_Bit7_MASK            0x80
...
#define DBGCAX_Bit16_MASK               0x01
#define DBGCAX_PAGSEL_MASK              0x20
#define DBGCAX_RWA_MASK                 0x40
#define DBGCAX_RWAEN_MASK               0x80
...
#define DBGCBX_Bit16_MASK               0x01
#define DBGCBX_PAGSEL_MASK              0x20
#define DBGCBX_RWB_MASK                 0x40
#define DBGCBX_RWBEN_MASK               0x80
...
#define DBGCCX_Bit16_MASK               0x01
#define DBGCCX_PAGSEL_MASK              0x20
#define DBGCCX_RWC_MASK                 0x40
#define DBGCCX_RWCEN_MASK               0x80
...
#define DBGFX_Bit16_MASK                0x01
#define DBGFX_PPACC_MASK                0x80
...
#define DBGS_ARMF_MASK                  0x01
#define DBGS_CF_MASK                    0x20
...
#define DBGCNT_CNT0_MASK                0x01
#define DBGCNT_CNT1_MASK                0x02
#define DBGCNT_CNT2_MASK                0x04
#define DBGCNT_CNT3_MASK                0x08
#define DBGCNT_CNT_MASK                 0x0F
#define DBGCNT_CNT_BITNUM               0x00
...
/*** SPI2C1 - SPI2 Control Register 1; 0x00001868 ***/
typedef union {
  byte Byte;
  struct {
    byte LSBFE       :1;                                       /* LSB First (Shifter Direction) */
...
extern volatile SPI2C1STR _SPI2C1 @0x00001868;
...
/*** SPI2C2 - SPI2 Control Register 2; 0x00001869 ***/
typedef union {
  byte Byte;
  struct {
    byte SPC0        :1;                                       /* SPI Pin Control 0 */
...
extern volatile SPI2C2STR _SPI2C2 @0x00001869;
...
/*** SPI2BR - SPI2 Baud Rate Register; 0x0000186A ***/
typedef union {
  byte Byte;
  struct {
    byte SPR0        :1;                                       /* SPI Baud Rate Divisor Bit 0 */
...
extern volatile SPI2BRSTR _SPI2BR @0x0000186A;
...
/*** SPI2S - SPI2 Status Register; 0x0000186B ***/
typedef union {
  byte Byte;
  struct {
    byte             :1; 
...
extern volatile SPI2SSTR _SPI2S @0x0000186B;
...
/*** SPI2D - SPI2 Data Register; 0x0000186D ***/
typedef union {
  byte Byte;
} SPI2DSTR;
extern volatile SPI2DSTR _SPI2D @0x0000186D;
