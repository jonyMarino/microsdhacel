...
const TDato datoFuente={
  (int*)&epm203Conf+offsetof(struct EPM203Conf,fuente),							      /* Direccion del parámetro a Escribir*/
...
const TDato datoDireccion={
  (int*)&epm203Conf+offsetof(struct EPM203Conf,direccion),							      /* Direccion del parámetro a Escribir*/
