...
#define TIECOUNTER TC##3
#define TIEFLAG TFLG1_C##3##F
...
void TI1_Init(void)
{
  ...
  TIECOUNTER = TICKS_1ms;                          /* Store value to the compare register */
  setReg8(TIE, TIE_C3I_MASK);
}
...
ISR(TI1_Interrupt)
{
  TIECOUNTER+= CmpVal;                       /* Add value corresponding with periode */
  TIEFLAG = 1;                           /* Reset interrupt request flag */
  Cpu_EnableInt();
