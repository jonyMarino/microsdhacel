...
void SenTPT_AddOnNew(struct TSensor_TermoPT * self,void(*method)(void*),void*Obj);
void SenTPT_Print(struct TSensor_TermoPT * self,uchar num_display); 
int SenTPT_getDifDecView(struct TSensor_TermoPT * self);
...
/*
** =====================================================================
**     Method      :  SenTPT_getTiempoMuestreo 
