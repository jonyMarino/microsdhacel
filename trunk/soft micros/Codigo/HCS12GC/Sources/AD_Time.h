...
**     Reference  :
**          AD_TIME(en segundos) = 0,000448*KNMEDCH*(CANTIDAD_CANALES+1) +0,04 (tiempo de grabacion)
...
#include "Mydefines.h"
    ...
    #define KNMEDCH     357		 /*Numero de secuencias para obteber el resultado final*/
  
  #elif defined(AD_250ms)
    #define KNMEDCH     178		 /*Numero de secuencias para obteber el resultado final*/
  ...
  #elif defined(AD_500ms) 
    #define KNMEDCH     535		 /*Numero de secuencias para obteber el resultado final*/
  
  #elif defined(AD_250ms)
    #define KNMEDCH      267		 /*Numero de secuencias para obteber el resultado final*/
