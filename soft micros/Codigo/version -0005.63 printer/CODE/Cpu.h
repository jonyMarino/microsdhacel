...
#define CPU_DERIVATIVE_MC9S12GC64      /* Name of the selected cpu derivative */
#define CPU_PARTNUM_MC9S12GC64CFU16    /* Part number of the selected cpu */
