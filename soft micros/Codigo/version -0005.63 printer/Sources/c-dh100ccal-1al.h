...
////////////////////VISUALIZACION//////////////////////////////////
#define MAX_DIGITOS 25 /* Tamaño del texto más largo*/
#define TIME_SCROLL 200 /* multiplicador de tiempo de scroling*/
#define MAIN_TEXT_PERIOD 6000 /* periodo del cambio de mensaje en el display inferior para la pantalla Main*/
#define MAIN_TEXT_TIME 3000 /* tiempo que estará el mensaje en el display inferior para la pantalla Main*/
...
#define ERR_UF 2						 /*Error de la funcion de linealizacion*/
 ...
 #define numver "5.62 101ccAL 1AL    "
