...
extern word BackupArray[256];								/* Array for backup data from erased sector */
...
{ byte i;
  extern volatile const long Id;
  msn[Step]=dat;
  switch(Step){
    
    case 0:    
      if (ASespera!=0 || msn[0]!=Id || StepTx)
        break;
    case 1:
    case 2:
    case 3: //Address 2
              ...
              Data = *(word *)&msn[4]; 
                ...
                *(volatile word*)Address =Data;													
                ...
                if(SavedAddress==(Address&65024) && !(Address&1)){
                  ...
                  IndiceFlash[(Address&511)/16]|=(1<<(((Address&511)/2)%8));
								  RSave_espera = 10;
                  RSave = TRUE;
                  AS1_Tx=TRUE; //enviar 
                }
