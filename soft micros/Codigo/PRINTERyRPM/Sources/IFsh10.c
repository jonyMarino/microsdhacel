...
//extern int PRom[PARAMETROS];          /* Array for backup data */ 
#ifdef jony_22_08
word IndiceFlash[MEM_PAGINA/16]; /* Indice de parametros modificados*/
byte BackupArray[MEM_PAGINA];								/* Array for backup data from erased sector */
#endif
word PageAddr;
...
byte IFsh10_GrabarFlash2(word PageAddr, word* Array)
{
  byte err;
