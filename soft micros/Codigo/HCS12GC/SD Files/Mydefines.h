...
#define CANTIDAD_CANALES 4 /*Cantidad de canales */

#define CANTIDAD_SAL_CONTROL   4 /*Cantidad de salidas control*/

#define CANTIDAD_SAL_ALARMA  4 /*Cantidad de salidas alarma */

#define _STR_VERSION "007.2"
///Entradas (Canal de entrada al que están asociadas)////////
//// Salidas//////
#define _STR_MODELO "S101"
#define OUT_CNTR_1 0
#define OUT_CNTR_2 3
#define OUT_AL_1 2
#define OUT_AL_2 1
