...
**     Date/Time : 30/04/2008, 12:48 p.m.
**     Abstract  :
...
void PE_low_level_init(void)
{
  ...
  clrReg8Bits(PTM, 63);                 
  /* WOMM: WOMM5=1,WOMM4=1,WOMM3=1,WOMM2=1,WOMM1=1,WOMM0=1 */
  setReg8Bits(WOMM, 63);                
  ...
  clrReg8Bits(PIEP, 31);                
  /* PTP: PTP5=0,PTP4=0,PTP3=0,PTP2=0,PTP1=0,PTP0=0 */
  clrReg8Bits(PTP, 63);                 
  ...
  setReg8(TCTL1, 0);                    
  /* TIE: C7I=0,C6I=0,C5I=0,C4I=0,C2I=0,C1I=1,C0I=0 */
  clrSetReg8Bits(TIE, 245, 2);          
  /* TIOS: IOS7=1,IOS6=1,IOS5=1,IOS4=1,IOS2=1,IOS1=1,IOS0=1 */
  setReg8Bits(TIOS, 247);               
  /* TTOV: TOV7=0,TOV6=0,TOV5=0,TOV4=0,TOV2=0,TOV1=0,TOV0=0 */
  clrReg8Bits(TTOV, 247);               
  ...
  setReg8(PWME, 0);                     
  /* MODRR: MODRR3=1,MODRR1=1 */
  setReg8Bits(MODRR, 10);               
  /* PWMCTL: CON45=1,CON23=1,CON01=1,PSWAI=0,PFRZ=0 */
  setReg8Bits(PWMCTL, 112);      
  /* PWMCAE: CAE5=0,CAE3=0,CAE1=0 */
  clrReg8Bits(PWMCAE, 42);              
  /* PWMPOL: PPOL5=0,PPOL3=0,PPOL1=0 */
  clrReg8Bits(PWMPOL, 42);              
