...
#include "Hardware/BitIn/BitIn.hpp"
/* User definitions */
#define SD_BLOCK_512     
...
/* Prototypes */
VUINT8 SD_Init(ISPI &spi,BitIn& sdPresent);
VUINT8 SD_SendCommand(VUINT8,VUINT8);
void SD_CLKDelay(VUINT8);
VUINT8 SD_Write_Block(VUINT32,VUINT8*);
VUINT8 SD_Read_Block(VUINT32,VUINT8*); 
